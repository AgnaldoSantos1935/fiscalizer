...
CREATE TABLE `medicao` (
  ...
  `valor_unitario_pf` decimal(10,2) DEFAULT 0.00,
  ...
  KEY `idx_medicao_contrato` (`contrato_id`),
  CONSTRAINT `medicao_ibfk_1` FOREIGN KEY (`contrato_id`) REFERENCES `contratos` (`id_contrato`)
...
INSERT INTO `medicao` VALUES (1,1,'2025-09',21.00,1200.00,25200.00,'2025-10-23','pendente',NULL);
