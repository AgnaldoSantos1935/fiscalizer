...
use App\Models\ProjetoSoftware; use App\Models\FiscalizacaoProjeto;
use App\Http\Requests\StoreFiscalizacaoProjetoRequest; use App\Http\Requests\UpdateFiscalizacaoProjetoRequest;
...
$fiscalizacao->delete(); return back()->with('success','Registro removido.');
}
}
