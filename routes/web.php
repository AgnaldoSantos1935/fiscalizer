...
use App\Http\Controllers\AtaRegistroPrecoController;
...
Route::resource('atas', AtaRegistroPrecoController::class);
Route::post('atas/{ata}/adesoes', [AtaRegistroPrecoController::class, 'storeAdesao'])->name('atas.adesoes.store');
Route::post('adesoes/{adesao}/gerar-pdf', [AtaRegistroPrecoController::class, 'gerarAutorizacaoPdf'])->name('adesoes.gerar_pdf');
Route::post('adesoes/{adesao}/status', [AtaRegistroPrecoController::class, 'atualizarStatusAdesao'])->name('adesoes.status');
