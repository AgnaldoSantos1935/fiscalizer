...
@section('breadcrumb')
  <nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb bg-white px-3 py-2 rounded-3 shadow-sm">
      <li class="breadcrumb-item"><a href="{{ route('atas.index') }}" class="text-decoration-none text-primary fw-semibold"><i class="fas fa-file-alt me-1"></i> Atas</a></li>
      <li class="breadcrumb-item active text-secondary fw-semibold">Editar Ata {{ $ata->numero }}</li>
    </ol>
  </nav>
@endsection
<div class="container-fluid">
  ...
  <div class="mt-4 card p-3">
    ...
    <form method="POST" action="{{ route('atas.adesoes.store',$ata->id) }}" class="row g-3">
      ...
      <div class="col-md-3"><label class="form-label">Valor Estimado</label><input type="text" name="valor_estimado" class="form-control money-br-input"></div>
