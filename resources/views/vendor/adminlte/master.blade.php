...
<head>
    ...
    {{-- Base Meta Tags (override ativo) --}}
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    {{-- Custom Meta Tags (override) --}}
    <meta name="app-name" content="{{ config('app.name', 'Fiscalizer') }}">
    @yield('meta_tags')
    @stack('head_meta')
...
<body class="@yield('classes_body')" @yield('body_data') data-master-override="true">
